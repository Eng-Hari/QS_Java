    ...
    public static void main(String[] args) throws Exception {
        ...
        if (opp > 0 && opp < 4) {
            ...
            switch (opp) {
                ...
                default: {
                    System.out.println("Invalid Restaurant option, Please Try Agian...!");
                }
            ...
            if (order > 0 && order < 4) {
                ...
                if (ans == 'y') {
                    ...
                    if (cash == bill) {
                        ...
                        System.out.println("\nOrder Cancelled due to wrong payment,  Sorry..!");
            ...
            System.out.println("Wrong Restarunt Option, Please Tryagain..!");
        }
